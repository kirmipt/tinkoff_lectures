...
иссл-я для генережки гипотез(custdev etc.), метрики приложения, особенности АБ, нелинейный путь польз-ля - графы
...
________
**Фреймворк поиска причин аномалий**
...
<br>8 операц-нные(измен-я инструкций для работников и мотивации)
<br>9 дозревание

<br> **моя версия**: 
<br>1 достат ли объем выб, проверить стат значимость
<br>2 постеп или резк
<br>(эффект в начале воронки
до конца медленно дойдет)
<br>3 сегментация, когорты
<br>4: ищем причину: 9 вариантов
<br>
<br>1 чек структуру процесса и вазимосв метрик/данных
<br>- вз-зь с др данными/метриками
<br>- С чем коррелирует?
<br>- Локализуй
<br>- Поищи детали
<br>2 сравн с др аномалиями
<br>2 свои ошибки - техн/идейн/дизайн теста
<br>3 кач-во данных - хранилище не обновилось
<br>4 техн ошибки на странице или в пайплайне
<br>5 измен-я расчета процессов/пайплайна
<br>6 выбросы
<br>7 трафик изм-ся
<br>8 вн событ - др отдел аб-тест/фича, обновление
<br>
<br>9 операц-нные(измен-я инструкций для работников и мотивации) 
<br>10 дозревающие метрики
<br>
<br>11 сезонность
<br>12 Внеш событ: 

<br>0 Партнеры
<br>1 Деятельность конкурентов (конкуренты снизили цены на продукт, и
активность ваших пользователей уменьшилась);
<br>3 Праздники (увеличение спроса на подарки)
<br>4 Распродажи, акции, маркетинговые активности 
<br>5 Особые события (например, покупки товаров для школы в августе);
<br>6 Изменение в политической и экономической обстановке (кризис,
