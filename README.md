...
<br>**1 Метрики** - пользовательские, конверсия, операционные, NPS PnL NPV, как смотреть по-разному на метрики
<br>**2 Как принимать решения** - как по-разному смотреть на метрики(подробнее), поиск причин аномалий, NPV-отчеты
